      ...
      if(reblog != null) {
        return (
          <li className="item" key={index}>
            ...
            <a className="QiitaApp-link" href={item.url} target="_blank" rel="noreferrer">{title}</a> {dayjs(item.created_at).fromNow(true)} 繝ｪ繝励Λ繧､謨ｰ:{item.replies_count} fav謨ｰ:{item.favourites_count}
          </li>
        );
      }
      else {
