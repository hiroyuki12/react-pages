...
function CaliYoutube() {
  ...
  return (
    ...
    Let's see the toilet real quick. Let's take a little break.<br />
    ...
    What in here? This is a toilet.<br />
    中には何があるかな？これは便器ね。<br />
    ...
    Dad is mad. And we don't know why?<br />
    父は狂気。理由は何故？<br />
    ...
    We gonna find out. But we will probably die.<br />
    原因を探す。けど、きっと死ぬ。<br />
    ...
    I will not rap, un less I become unhinged.<br />
    ...
    Probably because my free style is,<br />
