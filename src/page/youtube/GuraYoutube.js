...
function GuraYoutube() {
  ...
  return (
    ...
    <p><Link to='/react-pages'>Back</Link></p>
    ...
    My name, we well, we already established that right? We're on first name basis.<br />
    ...
    But I'm going ahead to decided to choose,<br />
    でも、いつにするか決めないと...<br />
    ...
    Maybe I shouldn't have choose this,<br />
    この日を選ばなきゃ良かったぁ〜<br />
    ...
    because you can see how nervous I am from may handwriting.<br />
    私が緊張してるの文字でバレちゃう。<br />
    ...
    you probably wondering who this is.<br />
    ...
    This is my long time friend, Bloop.<br />
    彼はね、古くからの友達のブループ。<br />
    ...
    lets just say its for the better for everybody here that he stays in the bubble. You know.<br />
    ...
    trust me I've lived with him long enough to know.<br />
    ...
    So he can't hear anything right now<br />
    今、彼は泡で何も聞こえないけど<br />
    ...
    well his in emergency ration, so<br />
    彼は非常食を被っているから...<br />
